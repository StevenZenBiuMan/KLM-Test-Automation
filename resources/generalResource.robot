...
${popUp}                      ${ANDROID_APP_PACKAGE}:id/com_ad4screen_sdk_pop_primary_button
...
Setup
  ...
  Wait Until Page Contains  Netherlands  timeout=2
...
Handle Feedback Popup 
   ...
   ${present}=  Run Keyword And Return Status    Wait Until Page Contains Element   No  timeout=30
   log    ${present}
